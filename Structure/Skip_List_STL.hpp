...
public:
    ...
    Skip_List_S<cls> &operator=(Skip_List_S<cls> &&) noexcept = default;

    Skip_List_S<cls> &operator=(Skip_List_S<cls> const &) = default;

    Skip_List_S(Skip_List_S<cls> &&) noexcept = default;

    Skip_List_S(Skip_List_S<cls> const &) = default;
