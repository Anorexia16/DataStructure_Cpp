#ifndef DATASTRUCTURE_TREAP_R_HPP
#define DATASTRUCTURE_TREAP_R_HPP
...
class Treap_R {
public:
    Treap_R(std::initializer_list<K_Tp> const &,
...
protected:
    ...
    void remove(kwargs *ptr);
};

template<typename K_Tp, typename V_Tp>
typename std::random_device Treap_R<K_Tp, V_Tp>::rd;

template<typename K_Tp, typename V_Tp>
typename std::default_random_engine Treap_R<K_Tp, V_Tp>::e
{Treap_R<K_Tp, V_Tp>::rd()};

template<typename K_Tp, typename V_Tp>
typename std::uniform_int_distribution<size_t>
        Treap_R<K_Tp, V_Tp>::ud (0, SIZE_MAX);

template<typename K_Tp, typename V_Tp>
template<typename I, typename II>
Treap_R<K_Tp, V_Tp>::Treap_R(I *key, II *value, size_t size):
Root {}
{
...
template<typename K_Tp, typename V_Tp>
Treap_R<K_Tp, V_Tp>::Treap_R(const std::initializer_list<K_Tp> &keys,
                         const std::initializer_list<V_Tp> &values)
:Root {nullptr}
{
...
template<typename K_Tp, typename V_Tp>
void Treap_R<K_Tp, V_Tp>::emplace(const K_Tp &key, const V_Tp &value) {
    if (Root == nullptr) {
...
template<typename K_Tp, typename V_Tp>
void Treap_R<K_Tp, V_Tp>::erase(const K_Tp &key) {
...
template<typename K_Tp, typename V_Tp>
void Treap_R<K_Tp, V_Tp>::insert(const std::pair<K_Tp, V_Tp> &pair) {
    this->emplace(pair.first, pair.second);
}

template<typename K_Tp, typename V_Tp>
V_Tp &Treap_R<K_Tp, V_Tp>::find(const K_Tp &key) const {
...
template<typename K_Tp, typename V_Tp>
bool Treap_R<K_Tp, V_Tp>::exist(const K_Tp &key) const {
...
template<typename K_Tp, typename V_Tp>
void Treap_R<K_Tp, V_Tp>::heapify(kwargs *ptr) {
    kwargs *fp;
...
template<typename K_Tp, typename V_Tp>
void Treap_R<K_Tp, V_Tp>::remove(Treap_R::kwargs *ptr) {
    kwargs *iter = ptr;
    while(true) {
...
#endif //DATASTRUCTURE_TREAP_R_HPP
